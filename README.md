...
1. Explain what a token is used for.
    ...
    token is used for authorization

2. What steps can you take in your web apps to keep your data secure?

    use a protected route or authentication header with out api calls

3. Describe how web servers work.

    web browser requests a page from the web server and then the web server give the page
